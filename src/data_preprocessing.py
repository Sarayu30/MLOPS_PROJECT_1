...
class DataProcessor:
    ...
    def balance_data(self, df):
        try:
            ...
            logger.error(f"Error occurred during data balancing: {str(e)}")
    ...
    def select_features(self, df):
        try:
            ...
            logger.error(f"Error occurred during feature selection: {str(e)}")
    ...
    def save_data(self,df, file_path):
        try:
            ...
            logger.info(f"Data saved successfulyy to {file_path}")
        except Exception as e:
            logger.error(f"Error occurred during data balancing: {str(e)}")
